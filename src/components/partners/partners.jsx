  ...
  return (
    <div className="partnersContainer">
      ...
      <div className="partnersGridContainer">
        ...
        {/* <div className="partnersItem">
          <img className="partnerImg" src="/assets/Website Graphics/partnerImage/California News Times.png" alt="cg" />
        </div>
        <div className="partnersItem">
          <img className="partnerImg" src="/assets/Website Graphics/partnerImage/Cyrpto News.png" alt="cg" />
        </div>
        <div className="partnersItem">
          <img className="partnerImg" src="/assets/Website Graphics/partnerImage/LA Weekly.png" alt="cg" />
        </div>
        <div className="partnersItem">
          <img className="partnerImg" src="/assets/Website Graphics/partnerImage/Tech Times.png" alt="cg" />
        </div>
        <div className="partnersItem">
          <img className="partnerImg" src="/assets/Website Graphics/partnerImage/SFW.png" alt="cg" />
        </div> */}
      </div>
    </div>
  )
