...
export default function press_first() {
  return (
    <div className="container">
        ...
        <div className="item">
            <img className="left" src="/assets/Website Graphics/Bubbles/cg.png" alt="" />
        ...
        <div className="item">
        <img className="middle" src="/assets/Website Graphics/Bubbles/cg.png" alt="" />
        <h3>LA Weekly</h3>
        ...
        <div className="item">
        <img className="right" src="/assets/Website Graphics/Bubbles/cg.png" alt="" />
        <h3>Yahoo! Finance</h3>
